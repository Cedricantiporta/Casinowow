...
export type GameTheme = 'NEON' | 'EGYPT' | 'DRAGON' | 'PIRATE' | 'SPACE' | 'CANDY' | 'JUNGLE' | 'UNDERWATER' | 'WESTERN' | 'SAMURAI' | 'PIGGY' | 'GOLDEN_POT' | 'LEPRECHAUN' | 'ARCTIC' | 'PETS' | 'MMORPG' | 'FARM' | 'BEAST' | 'ANGRYFLOCK' | 'PRINCESS' | 'OLYMPUS' | 'BUFFALO';
...
export interface PlayerState {
  ...
  vipXpBoostMultiplier?: number;  // VIP level-progress multiplier while active
  vipXpBoostEndTime?: number;
