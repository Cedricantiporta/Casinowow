...
const SYMBOL_MAP: Record<GameTheme, Record<SymbolType, string>> = {
  ...
  PIRATE: {
    ...
    [SymbolType.WILD]: 'WILD', [SymbolType.SCATTER]: '/pirate/skull.png', ...JP_ICONS
  },
  SPACE: {
    [SymbolType.TEN]: '10', [SymbolType.JACK]: 'J', [SymbolType.QUEEN]: 'Q', [SymbolType.KING]: 'K', [SymbolType.ACE]: 'A',
  ...
  CANDY: {
    [SymbolType.TEN]: '/candy/sugar1.png', [SymbolType.JACK]: '/candy/sugar2.png', [SymbolType.QUEEN]: '/candy/sugar3.png', [SymbolType.KING]: '/candy/sugar4.png', [SymbolType.ACE]: '/candy/sugar5.png',
    [SymbolType.GRAPE]: '/candy/sugar6.png', [SymbolType.BELL]: '/candy/sugar7.png', [SymbolType.BAR]: '/candy/sugar8.png', [SymbolType.CHERRY]: '/candy/sugar9.png', [SymbolType.SEVEN]: '/candy/sugar10.png',
    [SymbolType.WILD]: 'WILD', [SymbolType.SCATTER]: '/candy/sugar11.png', ...JP_ICONS
  },
  JUNGLE: {
    [SymbolType.TEN]: '10', [SymbolType.JACK]: 'J', [SymbolType.QUEEN]: 'Q', [SymbolType.KING]: 'K', [SymbolType.ACE]: 'A',
...
export const GET_SYMBOLS = (theme: GameTheme): Record<SymbolType, SymbolConfig> => {
  ...
  return {
    [SymbolType.TEN]:   { type: SymbolType.TEN,   icon: icons.TEN,   value: 0.5,  ...LTR.TEN,  ...egyptLtr, ...(isDragon && { imageScale: 0.85 }), ...(isCandy && { imageScale: 1.2 }) },
    [SymbolType.JACK]:  { type: SymbolType.JACK,  icon: icons.JACK,  value: 0.75, ...LTR.JACK, ...egyptLtr, ...(isCandy && { imageScale: 1.2 }) },
    [SymbolType.QUEEN]: { type: SymbolType.QUEEN, icon: icons.QUEEN, value: 1,    ...LTR.QUEEN, ...egyptLtr, ...(isDragon && { imageScale: 0.85 }), ...(isCandy && { imageScale: 1.2 }) },
    [SymbolType.KING]:  { type: SymbolType.KING,  icon: icons.KING,  value: 1.5,  ...LTR.KING, ...egyptLtr, ...(isCandy && { imageScale: 1.2 }) },
    [SymbolType.ACE]:   { type: SymbolType.ACE,   icon: icons.ACE,   value: 2,    ...LTR.ACE,  ...egyptLtr, ...(isCandy && { imageScale: 1.2 }) },
    [SymbolType.GRAPE]:   { type: SymbolType.GRAPE,   icon: icons.GRAPE, value: 2.5,  style: 'text-emerald-100 drop-shadow-md', bg: imgTheme ? T : TILE_BGS.GREEN, highlightClass: imgTheme ? 'shadow-[0_0_50px_rgba(255,255,255,0.6)] border-white/50' : 'bg-emerald-600/40 shadow-[0_0_50px_rgba(5,150,105,0.8)] border-emerald-400/50', ...((isPirate || isPiggy || isArctic || isCandy) && { imageScale: 1.3 }) },
    [SymbolType.BELL]:    { type: SymbolType.BELL,    icon: icons.BELL, value: 4.5,  style: 'text-blue-100 drop-shadow-[0_0_5px_#3b82f6]', bg: imgTheme ? T : TILE_BGS.BLUE, highlightClass: imgTheme ? 'shadow-[0_0_50px_rgba(255,255,255,0.6)] border-white/50' : 'bg-blue-600/40 shadow-[0_0_50px_rgba(37,99,235,0.8)] border-blue-400/50', ...((isPirate || isPiggy || isArctic || isCandy) && { imageScale: 1.3 }) },
    [SymbolType.BAR]:     { type: SymbolType.BAR,     icon: icons.BAR, value: 7.5,  style: 'text-purple-100 drop-shadow-[0_0_5px_#a855f7]', bg: imgTheme ? T : TILE_BGS.PURPLE, highlightClass: imgTheme ? 'shadow-[0_0_50px_rgba(255,255,255,0.6)] border-white/50' : 'bg-purple-600/40 shadow-[0_0_50px_rgba(147,51,234,0.8)] border-purple-400/50', ...((isPirate || isPiggy || isArctic || isCandy) && { imageScale: 1.3 }) },
    [SymbolType.CHERRY]:  { type: SymbolType.CHERRY,  icon: icons.CHERRY, value: 11, style: 'text-red-100 drop-shadow-[0_0_5px_#ef4444]', bg: imgTheme ? T : TILE_BGS.RED, highlightClass: imgTheme ? 'shadow-[0_0_50px_rgba(255,255,255,0.6)] border-white/50' : 'bg-red-600/40 shadow-[0_0_50px_rgba(220,38,38,0.8)] border-red-400/50', ...((isPirate || isPiggy || isArctic || isCandy) && { imageScale: 1.3 }) },
    [SymbolType.SEVEN]:   { type: SymbolType.SEVEN,   icon: icons.SEVEN, value: 15.625, style: 'text-yellow-100 drop-shadow-[0_0_10px_#eab308]', bg: imgTheme ? T : TILE_BGS.YELLOW, highlightClass: imgTheme ? 'shadow-[0_0_50px_rgba(255,255,255,0.6)] border-white/50' : 'bg-yellow-600/40 shadow-[0_0_50px_rgba(234,179,8,0.8)] border-yellow-400/50', ...((isPirate || isPiggy || isArctic || isCandy) && { imageScale: 1.3 }) },
    ...
    [SymbolType.SCATTER]: { type: SymbolType.SCATTER, icon: icons.SCATTER, value: 0, style: 'text-white drop-shadow-[0_0_15px_#3F51B5]', bg: imgTheme ? T : TILE_BGS.SCATTER, ...((isDragon || isEgypt) && { imageScale: 1.2 }), ...((isPirate || isPiggy || isArctic || isCandy) && { imageScale: 1.35 }) },
    ...
    [SymbolType.COIN]: { type: SymbolType.COIN, icon: icons[SymbolType.COIN] ?? '/symbols/coin.png', value: 3.5, style: 'drop-shadow-[0_0_8px_rgba(250,204,21,0.9)]', bg: (isPiggy || imgTheme) ? TILE_BGS.TRANSPARENT : TILE_BGS.YELLOW, highlightClass: 'bg-yellow-500/40 shadow-[0_0_50px_rgba(234,179,8,0.9)] border-yellow-300/50' },
  };
};
