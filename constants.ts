...
const PRINCESS_SLOT: GameConfig = {
    ...
    reels: 5,
    scattersToTrigger: 3,
    description: 'Enchanted Mirror! One royal symbol is crowned — land 3+ in free spins and it fills whole reels.',
...
export const GAMES_CONFIG: GameConfig[] = [
  ...
  },
  {
    ...
    reels: 6,
    scattersToTrigger: 3,
    description: 'Sticky Wild Reels! Wilds grow to fill their reel and stay locked for 2 spins — free-spin wilds stay longer and add spins.',
  ...
  },
  {
    ...
    reels: 6,
    scattersToTrigger: 3,
    description: 'Rainbow Trail! 3 scatters start the climb — spin to advance rising multipliers to the pot of gold.',
  ...
  },
  {
    ...
    reels: 6,
    scattersToTrigger: 3,
    description: 'Choose your companion! Each pet grants its own style of free spins.',
