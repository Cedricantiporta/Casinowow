...
const MECHANIC_INFO: Record<GameTheme, { title: string; body: string }> = {
    ...
    GOLDEN_POT: { title: 'Three Fortune Pots', body: 'Spins, Jackpot and Multiplier pots fill gradually as you play. Any full pot can burst — always awarding at least 10 free spins. Which pot(s) fired decides the session: the Jackpot pot lets 3+ matching jackpot symbols pay out, the Multiplier pot gives wilds a random 2x-5x tag every spin, and if the Spins pot is part of the burst its stacked bonus spins are added on top.' },
    SAMURAI: { title: 'Sticky Wild Reels', body: 'A wild landing on a middle reel grows to fill the whole reel and stays locked for 2 spins. During free spins, wilds can land on any reel, stay locked for 3 spins, and each new locked reel adds an extra free spin.' },
