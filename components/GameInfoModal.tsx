...
const MECHANIC_INFO: Record<GameTheme, { title: string; body: string }> = {
    ...
    GOLDEN_POT: { title: 'Fortune Pot Drip + Instant Pots', body: 'Every 10th spin drops a pot worth 1x-5x your bet automatically. During free spins, fortune pots can also land on the reels and pay instantly.' },
    ...
    UNDERWATER: { title: 'Win Both Ways + Kraken Attack', body: 'Paylines pay left-to-right and right-to-left. On a dead spin, the Kraken can crush 1-2 reels fully wild before scoring.' },
    WESTERN: { title: 'Dynamite + High Noon Duel', body: 'Dead spins can trigger a dynamite blast, turning 4-6 random cells wild. Mid-size wins can be risked in a High Noon Duel — double or nothing, up to 3 rounds.' },
