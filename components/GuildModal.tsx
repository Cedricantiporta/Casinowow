                                    ...
                                    {tasks.map(t => {
                                        ...
                                        return (
                                            <div key={t.id} className={`${isMaxReward ? 'tcard-goldpurple' : 'tcard'} flex flex-col items-center gap-2 p-2.5`}>
                                                ...
                                                <div className="font-bold text-center" style={{ fontSize: 8, color: t.rewardKind === 'GUILD_XP' ? 'rgba(250,204,21,0.75)' : 'rgba(125,211,252,0.75)' }}>
                                                ...
                                                <div className="w-full">
                                                    {t.completed && !t.claimed ? (
                                                        ...
                                                        <div className="flex justify-center"><i className="ti ti-check text-green-400" style={{ fontSize: 18 }} /></div>
                                                    ) : (
                                                        <button onClick={() => playerGems >= cost && onRefreshTask(t.id)} disabled={playerGems < cost} className="pill-blue w-full" style={{ opacity: playerGems < cost ? 0.5 : 1 }}>
                                                            <div className="pill-face flex items-center justify-center gap-1" style={{ padding: '5px 6px', fontSize: '8px', background: 'linear-gradient(180deg,#38bdf8,#0ea5e9,#0369a1)' }}>
