...
export const InboxModal: React.FC<InboxModalProps> = ({ isOpen, onClose, messages, onClaim }) => {
    ...
    return (
        ...
        <div className="w-full max-w-[420px] flex flex-col rounded-3xl overflow-hidden"
            style={{ height: 'min(80%, 520px)', background: 'linear-gradient(160deg,#8028c8 0%,#6018a8 50%,#4a1090 100%)', boxShadow: 'inset 0 2px 0 rgba(220,170,255,0.9), 0 8px 32px rgba(0,0,0,0.8)' }}>
            {/* Header */}
