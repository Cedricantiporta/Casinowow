...
export const CardCollectionModal: React.FC<CardCollectionModalProps> = ({
    ...
    return (
        <div className="absolute inset-0 z-[150] flex flex-col animate-pop-in" style={{ background: 'linear-gradient(rgba(0,0,0,0.35),rgba(0,0,0,0.35)),url(/cards_bg.png) center/cover no-repeat' }}>
